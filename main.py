...
class TwitterComplaintBot:
    ...
    def speed_finder(self):
        ...
        time.sleep(3)
        all_cookies = self.driver.find_element(By.XPATH, '//*[@id="onetrust-accept-btn-handler"]')
        all_cookies.click()
    ...
    def tweet_composer(self):
        ...
        time.sleep(6)
        field_place = self.driver.find_element(By.XPATH,
                                               '//*[@id="layers"]/div[2]/div/div/div/div/div/div[2]/div[2]/div/div/div/div[3]/div/div[1]/div/div/div/div/div[2]/div[1]/div/div/div/div/div/div[2]/div/div/div/div/label/div[1]/div/div/div/div/div/div[2]/div/div/div/div/span/br')
        time.sleep(2)
